...
?>>
        ...
        <div class="item">
            <input type="checkbox" name="canPickUp" value="canPickUp" id="canPickUp"
                   <?php
  if ($canPickUp) {
    echo 'checked="checked" ';
  }
...
<input type="label" name="pickUpRangeIterator" id="pickUpRangeIterator" value="1">

<input type="label" name="rangeDelList" id="rangeDelList" value="">    
   
<input type="label" name="rangeEditList" id="rangeEditList" value=""> 
